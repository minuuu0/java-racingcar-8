...
- [x] 이동 횟수만큼 각 자동차별 무작위 값을 구한다
- [x] 무작위 값이 4 이상이면 한 칸을 이동한다
- [x] 무작위 값이 3 이하이면 이동하지 않는다
- [x] 이동 횟수에 도달하면 가장 많이 이동한 자동차가 우승자가 된다

### 출력 기능

- [x] 경주할 자동차 이름 목록을 형식에 맞게 출력한다
- [x] 시도할 횟수를 형식에 맞게 출력한다
- [x] 입력된 횟수마다 자동차 결과를 형식에 맞게 출력한다
